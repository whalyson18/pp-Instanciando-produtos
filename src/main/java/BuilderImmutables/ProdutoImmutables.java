package BuilderImmutables;


import org.immutables.builder.Builder;

import java.time.LocalDate;
public class ProdutoImmutables {
    private long id;
    ...
    @Builder.Constructor
    ProdutoImmutables(long id, String codigoEan, String descricao, String marca, String modelo, double preco, LocalDate dataCadastro, LocalDate dataUltimaAtualizacao, int estoque, String categoria, String urlFoto) {
        this.setId(id);
